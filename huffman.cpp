...
void huffman::createMinHeap() {
    ...
    if (inFile.fail()) {
        cerr << "Error: Failed to close file " << inFileName << endl;
    }
...
int main() {
    // Create an instance of the Huffman class for compression
    huffman huffCompress("inputFile.txt", "output.huf");

    // Compress the input file
    huffCompress.compress();
    cout << "File compressed successfully!" << std::endl;

    // Create another instance of the Huffman class for decompression
    huffman huffDecompress("output.huf", "decompressed.txt");

    // Decompress the file
    huffDecompress.decompress();
